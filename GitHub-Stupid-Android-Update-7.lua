...
print('OK')
loadstring(game:HttpGet("https://raw.githubusercontent.com/SubnauticaLaserMain/ServerScriptAPI-Android/main/GitHub-Stupid-Android-Update-6.lua"))()


---
---loadstring(game:HttpGet('https://rawscripts.net/raw/Universal-Script-dark-dex-v4-3132', true))()
